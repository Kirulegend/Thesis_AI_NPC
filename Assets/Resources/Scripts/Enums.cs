...
public enum Job { None, Gamer, Programmer, Student, Artist, Doctor, Athlete, Old_Patrol }

public enum State{ None, Idle, Moving, Thinking, Chatting, Resting, Waiting, Eating }
#endregion
